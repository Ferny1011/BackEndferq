...
public class EducacionController {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion) {
        ...
        if (StringUtils.isBlank(dtoeducacion.getImgE())) {
        ...
        Educacion educacion = new Educacion(dtoeducacion.getTituloE(), dtoeducacion.getFechaE(), dtoeducacion.getDescripcionE(), dtoeducacion.getImgE(),dtoeducacion.getUrlE());
